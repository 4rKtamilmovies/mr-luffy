...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href=https://t.me/+3oEtjF8Th585YmZl>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a>.</b>")
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("🧑‍🎓 ᴏᴡɴᴇʀ", url="t.me/JitPeterParkerPM_Bot")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/JitPeterParkerPM_Bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
